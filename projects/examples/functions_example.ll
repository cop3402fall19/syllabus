...
define i32 @factorial_recursive(i32) {
  %x = alloca i32
  store i32 %0, i32* %x, align 4  ; %0 is the first parameter

  ; function body
  %result = alloca i32
  store i32 1, i32* %result, align 4
  %t1 = load i32, i32* %x, align 4
...
label2:
  ...
  %t5 = sub nsw i32 %t4, 1
  %t6 = call i32 @factorial_recursive(i32 %t5)
  %t7 = mul nsw i32 %t3, %t6
  store i32 %t7, i32* %result, align 4  ; %0 is the first parameter
  br label %label3

label3:
  %t8 = load i32, i32* %result, align 4
  ret i32 %t8 ; last statement should be a return
}
...
define i32 @mult(i32, i32) {
  ...
  %t1 = load i32, i32* %left, align 4
  %t2 = load i32, i32* %right, align 4
  %t3 = mul nsw i32 %t1, %t2
  ret i32 %t3
}

; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @factorial_iterative(i32) #0 {
  %x = alloca i32, align 4
  store i32 %0, i32* %x, align 4

  %result = alloca i32, align 4
  store i32 1, i32* %result, align 4
  br label %label1  ; need branch before label
label1:
  %t1 = load i32, i32* %x, align 4
...
label2:
  %t3 = load i32, i32* %result, align 4
  %t4 = load i32, i32* %x, align 4
  %t5 = call i32 @mult(i32 %t3, i32 %t4)
  store i32 %t5, i32* %result, align 4
...
define i32 @main() {
  ...
  %t2 = call i32 @factorial_recursive(i32 4)
  call void @print_integer(i32 %t2)
  %t3 = call i32 @factorial_iterative(i32 4)
